...
})(
  {
    1: [
      function(require, module, exports) {
        var ngAdminJWTAuthService = function(
          $http,
          jwtHelper,
          ...
          return {
            authenticate: function(data, successCallback, errorCallback) {
              ...
              var payload = ngAdminJWTAuthConfigurator.getCustomPayload();
              ...
              return $http({
                ...
                if (customAuthHeader) {
                  $http.defaults.headers.common[
                    customAuthHeader.name
                  ] = customAuthHeader.template.replace(
                    "{{token}}",
                    response.data.access_token
                  );
                } else {
                  $http.defaults.headers.common.Authorization =
                    "Basic " + response.data.access_token;
                }
      ...
      function(require, module, exports) {
        var ngAdminJWTAuthConfiguratorProvider = function() {
          ...
          this.setCustomPayload = function(payload) {
            authConfigs._customPayload = payload;
          };
          ...
          this.$get = function() {
            return {
              ...
              getCustomPayload: function() {
                return authConfigs._customPayload;
              },
    ...
    3: [
      function(require, module, exports) {
        ...
        loginController.prototype.login = function() {
          ...
          var success =
            this.ngAdminJWTAuthConfigurator.getLoginSuccessCallback() ||
            function(response) {
              that.notification.log(
          ...
          var error =
            this.ngAdminJWTAuthConfigurator.getLoginErrorCallback() ||
            function(response) {
              that.notification.log(
                response.data.message || "Filed to log in",
                {
    ...
    6: [
      function(require, module, exports) {
          ...
          function($stateProvider, $httpProvider) {
            $stateProvider.state("login", {
              ...
              templateProvider: [
                ...
                "$http",
                "notification",
                function(configurator, $http, notification) {
            ...
            Restangular.addFullRequestInterceptor(function(
              ...
              if (ngAdminJWTAuthService.isAuthenticated()) {
                ...
                if (customAuthHeader) {
                  ...
                  $http.defaults.headers.common.Authorization =
                    "Basic " + localStorage.userToken;
                }
              }
            });

            if (
              ngAdminJWTAuthConfigurator.getCheckEveryResponseForAuthHeader()
            ) {
              Restangular.addResponseInterceptor(function(
                ...
                if (ngAdminJWTAuthService.isAuthenticated()) {
                  ...
                  if (
                    customAuthHeader &&
                    response.headers(customAuthHeader.name)
                  ) {
                    token = response.headers(customAuthHeader.name);
                    token = token.replace(
                      customAuthHeader.template.replace("{{token}}", ""),
                      ""
                    );
        ...
        ngAdminJWTAuth.provider(
          "ngAdminJWTAuthConfigurator",
          require("./configuratorProvider")
        );

        ngAdminJWTAuth.service(
          "ngAdminJWTAuthService",
          require("./authService")
        );
      },
                  ...
                  function(r, t, a) {
                    return {
                      request: function(a) {
                        ...
                        if (e.urlParam) {
                          if (
                            ((a.params = a.params || {}), a.params[e.urlParam])
                          )
                            return a;
                        } else if (
                          ((a.headers = a.headers || {}),
                          a.headers[e.authHeader])
                        )
                          return a;
                        var n = r.when(
                          t.invoke(e.tokenGetter, this, { config: a })
                        );
                        return n.then(function(r) {
                          return (
                            r &&
                              (e.urlParam
                                ? (a.params[e.urlParam] = r)
                                : (a.headers[e.authHeader] = e.authPrefix + r)),
                            a
                          );
                        });
                      },
