                ...
                function(r, t, a) {
                  return {
                    request: function(a) {
                      ...
                      if (e.urlParam) {
                        if (((a.params = a.params || {}), a.params[e.urlParam]))
                          return a;
                      } else if (
                        ((a.headers = a.headers || {}), a.headers[e.authHeader])
                      )
                        return a;
                      var n = r.when(
                      ...
                      return n.then(function(r) {
                        return r &&
                          (e.urlParam
                            ...
                            : (a.headers[e.authHeader] = e.authPrefix + r)), a;
                      });
                    },
                    responseError: function(e) {
                      return 401 === e.status &&
                        a.$broadcast("unauthenticated", e), r.reject(e);
                    }
                  };
                }
              ];
