    ...
    3: [
      function(require, module, exports) {
        ...
        loginController.prototype.login = function() {
          ...
          var success = this.ngAdminJWTAuthConfigurator.getLoginSuccessCallback() ||
            function(response) {
              that.notification.log(response.data.message, { addnCls: "humane-flatty-success" });
              that.$location.path("/dashboard");
            };
          var error = this.ngAdminJWTAuthConfigurator.getLoginErrorCallback() ||
            function(response) {
    ...
    6: [
      function(require, module, exports) {
        ...
        ngAdminJWTAuth.run([
          ...
          "$rootScope",
          "ngAdminJWTAuthConfigurator",
          function($q, Restangular, ngAdminJWTAuthService, $http, $location, $state, $rootScope, ngAdminJWTAuthConfigurator) {
      ...
      { "./authService": 1, "./configuratorProvider": 2, "./loginController": 3, "./loginTemplate": 4, "./logoutController": 5 }
    ],
    7: [
      function(require, module, exports) {
        !(function() {
